...
export enum MavCmd {
  ...
  MAV_CMD_DO_GIMBAL_MANAGER_TILTPAN = 2000,
  ...
  MAV_CMD_DO_GIMBAL_MANAGER_TRACK_POINT = 2001,
  ...
  MAV_CMD_DO_GIMBAL_MANAGER_TRACK_RECTANGLE = 2002,
  // Start image capture sequence. Sends CAMERA_IMAGE_CAPTURED after each capture. Use NaN for reserved values.
  MAV_CMD_IMAGE_START_CAPTURE = 2003,
  // Stop image capture sequence Use NaN for reserved values.
  MAV_CMD_IMAGE_STOP_CAPTURE = 2004,
  // Re-request a CAMERA_IMAGE_CAPTURED message.
  MAV_CMD_REQUEST_CAMERA_IMAGE_CAPTURE = 2005,
  // Enable or disable on-board camera triggering system.
  MAV_CMD_DO_TRIGGER_CONTROL = 2010,
...
export enum MavArmAuthDeniedReason {
  ...
  MAV_ARM_AUTH_DENIED_REASON_TIMEOUT = 4,
  ...
  MAV_ARM_AUTH_DENIED_REASON_AIRSPACE_IN_USE = 5,
  // Weather is not good to fly
  MAV_ARM_AUTH_DENIED_REASON_BAD_WEATHER = 6,
}
